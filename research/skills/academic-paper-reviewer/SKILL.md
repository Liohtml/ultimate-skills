...
description: "Simulated multi-perspective peer review of an academic manuscript: a 5-seat, role-separated panel (journal-fit reviewer, 3 field-specific peer-review roles, devil's advocate) with dynamic personas, in full review, re-review (verifying a revision), quick assessment, methodology focus, Socratic guided and reviewer-calibration modes. Role separation is not a claim of independent error processes. Use when the user wants a paper, manuscript or thesis chapter reviewed, critiqued or refereed before submission, or wants a referee report. For acting on reviews already received use academic-paper (revision and rebuttal modes); for reviewing a non-academic text or fact-checking use deep-research; for the full write-review-revise loop use academic-pipeline. Triggers: review paper, peer review, manuscript review, referee report, simulate review, calibrate reviewer, 審查論文, 同儕審查, 模擬審查, 논문 심사, 동료 심사, revisar artículo, revisión entre pares."
metadata:
  version: "1.11.1"
