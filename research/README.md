...
## Skills
4 skills (see the table in the [root README](../README.md#research-cc-by-nc-40--non-commercial)): `deep-research`, `academic-paper`, `academic-paper-reviewer`, `academic-pipeline`.
