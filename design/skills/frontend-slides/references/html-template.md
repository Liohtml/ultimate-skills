> From [zarazhangrui/frontend-slides](https://github.com/zarazhangrui/frontend-slides) `html-template.md` at commit `9906a34` (MIT, (c) 2025 Zara Zhang). Unmodified except for this line.
