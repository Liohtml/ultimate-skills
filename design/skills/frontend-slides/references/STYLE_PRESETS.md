> From [zarazhangrui/frontend-slides](https://github.com/zarazhangrui/frontend-slides) `STYLE_PRESETS.md` at commit `9906a34` (MIT, (c) 2025 Zara Zhang). Only the viewport-base.css link path was changed.
