> From [jezweb/claude-skills](https://github.com/jezweb/claude-skills) `plugins/design-assets/skills/icon-set-generator/references/style-presets.md` at commit `e875a6b` (MIT, (c) 2025 Jeremy Dawes). Unmodified except for this line.
