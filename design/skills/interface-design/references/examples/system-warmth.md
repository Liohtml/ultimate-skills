> From [Dammyjay93/interface-design](https://github.com/Dammyjay93/interface-design) `reference/examples/system-warmth.md` at commit `2f9be32` (MIT, (c) 2026 Damola Akinleye). Unmodified.
