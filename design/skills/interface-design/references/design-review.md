> From [Dammyjay93/interface-design](https://github.com/Dammyjay93/interface-design) `.claude/commands/design-review.md` at commit `2f9be32` (MIT, (c) 2026 Damola Akinleye). Converted from a slash command to a reference file; command names replaced by the skill's mode names.
