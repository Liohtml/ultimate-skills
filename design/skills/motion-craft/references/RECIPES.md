> From [emilkowalski/skills](https://github.com/emilkowalski/skills) `skills/animate/RECIPES.md` at commit `85e8e23` (MIT, (c) 2026 Emil Kowalski). Only the token cross-reference was changed.
...
Curves are the `--ease-out`, `--ease-in-out`, and `--ease-drawer` tokens defined in the motion-craft `SKILL.md` (Build mode, step 5).
