# Design Systems: Install Commands, Canonical Sources, Liquid Glass

Reference material for the design-taste-frontend skill. Read this when the design read (SKILL.md Section 2) lands on a real design system and you need the install command or canonical docs, or when the brief asks for Apple Liquid Glass / glassmorphism on the web.

Install commands are reality anchors. The Apple Liquid Glass skeleton is a labeled approximation, not an Apple-issued package.
