...
> **Heuristic ranges.** Compiled by the upstream author from the public reports listed below; they are rules of thumb, vary by year, pricing model and funding environment, and should be replaced by the user's own targets where available. Re-check against current editions of the sources before relying on them.
