...
This skill is the method for finding that gap. It is the differentiator: it only works when intent has been written down first (see the **shipping-artifacts** skill — upstream pm-skills, not included here: https://github.com/phuryn/pm-skills/tree/main/pm-ai-shipping/skills/shipping-artifacts), and that's exactly why commodity tools can't replicate it.
