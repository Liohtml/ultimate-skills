...
> From [neondatabase/postgres-skills `backup-restore.md`](https://github.com/neondatabase/postgres-skills/blob/27fe45e0f71ea89a6eaf9ea4d2e4068957c81c26/skills/postgres-best-practices/references/backup-restore.md), Apache-2.0 (see `../LICENSE-neon-apache-2.0.txt`). Modified by ultimate-skills: attribution header added; otherwise unchanged.
