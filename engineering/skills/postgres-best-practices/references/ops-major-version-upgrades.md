...
> From [neondatabase/postgres-skills `major-version-upgrades.md`](https://github.com/neondatabase/postgres-skills/blob/27fe45e0f71ea89a6eaf9ea4d2e4068957c81c26/skills/postgres-best-practices/references/major-version-upgrades.md), Apache-2.0 (see `../LICENSE-neon-apache-2.0.txt`). Modified by ultimate-skills: attribution header added; cross-reference to the upstream logical-replication reference replaced with a link.
...
For the full live-migration pattern see the upstream [logical-replication reference](https://github.com/neondatabase/postgres-skills/blob/27fe45e0f71ea89a6eaf9ea4d2e4068957c81c26/skills/postgres-best-practices/references/logical-replication.md) and the [PostgreSQL logical replication docs](https://www.postgresql.org/docs/current/logical-replication.html).
