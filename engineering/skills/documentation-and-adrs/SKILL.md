...
description: "Records architecture decisions and technical documentation: ADRs (context, decision, alternatives, consequences), when and how to write code comments, API docs (typed inline docs, OpenAPI) and README structure. Use when making or changing an architectural decision worth recording, changing a public API, or when context that future engineers and agents will need is about to be lost. For product requirement docs use create-prd; for a pre-code engineering spec use spec-driven-development; for a conclusion-first decision memo use minto-pyramid; to remove AI-sounding phrasing from docs use humanizer."
---
