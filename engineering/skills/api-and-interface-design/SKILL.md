...
- **Plan for deprecation at design time.** See `deprecation-and-migration` (upstream agent-skills, not included here: https://github.com/addyosmani/agent-skills) for how to safely remove things users depend on.
